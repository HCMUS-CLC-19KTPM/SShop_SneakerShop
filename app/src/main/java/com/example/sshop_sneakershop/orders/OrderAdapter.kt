...
class OrderAdapter(private val orders:List<Order>): RecyclerView.Adapter<OrderAdapter.ViewHolder>() {
    inner class ViewHolder(listItemView: View): RecyclerView.ViewHolder(listItemView){
        val customerNameTextView = listItemView.findViewById(R.id.order_list_customer_name) as TextView
        val customerPhoneTextView = listItemView.findViewById(R.id.order_list_customer_phone) as TextView
        val customerAddressTextView = listItemView.findViewById(R.id.order_list_customer_address) as TextView
        val startDateTextView = listItemView.findViewById(R.id.order_list_start_date) as TextView
        val endDateTextView = listItemView.findViewById(R.id.order_list_end_date) as TextView
        val totalCostTextView = listItemView.findViewById(R.id.order_list_total_cost) as TextView
        val deliveryDescriptionTextView = listItemView.findViewById(R.id.order_list_delivery_description) as TextView
    }
